...
public class StudyjcgRecordOther extends JFrame implements ActionListener {
 
    String[] name = { "id", "jcgstdt","jcgStudy1","jcgStudy2","jcgStudy3", "jcgstt" };
     ...
     */
    JPanel p = new JPanel();
    String[] comboName = { "  ALL  ", "  ID  ", " jcgstdt" };
 
    JComboBox combo = new JComboBox(comboName);
    JTextField jtf = new JTextField(20);
    JButton serach = new JButton("검색");
 
    StudyjcgRecordOtherDAO dao = new StudyjcgRecordOtherDAO();
 
    /**
     * 화면구성 및 이벤트등록
     */
    public StudyjcgRecordOther() {
